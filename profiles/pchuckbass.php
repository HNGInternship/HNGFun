...
<head>
	...
	<style>
		body {
			background-image: url(http://res.cloudinary.com/moon-dock-group/image/upload/v1523734254/images_3.jpg);
		}
		...
		<div class="col-md-6 offset-md-3 frame">
			...
			<div class="row info">
				<div class="col-md-12">
					...
					<p class="text-center"><span class="occupation_span">What I do: </span>I am an Accountant by Profession, a Programming Enthusiast by Hobby, a Builder by Nature.</p>
				</div>
