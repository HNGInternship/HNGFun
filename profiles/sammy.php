...
<div id="tod">
    <div id="layer1">
            ...
            <div class="background">
                <div class="name"><h4>Achem Samuel - Web | UI/UX | Android Developer</h4>
                    <hr>
                        ...
                        <section id="carousel" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <figure class="item active" role="option">
                                    <p>
                                        I am a tech enthusiast, dedicated to learning and improving on my skills on a daily basis. 
                                        ...
                                        have applied the best of ourselves to the task at hand." </br> -<em>Vince Lombardi</em>
                                        </br>
                                ...
                                <figure class="item" role="option">
                                    <p>
                                        ...
                                        a great work ethic in me both personally and professionally." </br>
                                        -<em>Tamron Hall</em>
                                        </br>
                                         A major strong point for
                                        me in the design process is that the designer must clearly understand the mind og the client and
                                        work around the clock to help the client achieve this dream. It's in this that the designer should
                                        derive satisfaction.
                                    </p>
                                </figure>
                            </div>
                ...
                <div>
                    <img id="center" class="img-circle" src="https://res.cloudinary.com/dyuuulmg0/image/upload/v1523621000/sam1.jpg" alt="I am Achem Samuel"
                        ...
                        <div id="like"> <h5 style="text-align: justify">What I like</h5> <hr>
                            <li>
                                Music
                            </li>
                            <li>
