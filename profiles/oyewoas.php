...
?>
    ...
    ##About Bot
    function aboutbot() {
    echo "<div id='result'><strong>i.Code Bot 2018 </strong></br>
        Hi there, I am i.Code Bot, developed in 2018 by Oyewo, Ayooluwa. I can answer questions you ask and you can also train me to answer any question. Lets RIDE</div>";
    }
    ...
    echo "<div id='result'>Sorry! I've not been trained to learn that command. </br>Would you like to train me?
        ...
        </br>e.g train:Who is your developer#Oyewo, Ayooluwa#password</div>";
    }else {
                    ...
                    <nav class="navbar navbar-inverse" data-spy="" id="">
                        <div class="container">
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand" href="#" id="site">i.Code</a>
                            </div>
                ...
                <!-- <div class="modal fade" id="roundModal" tabindex="-1" role="dialog" aria-labelledby="modalTitle" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <img src="images/ayo2.jpg" alt="Content Solutions" class="img-responsive img-rounded">
                                <p>I am Ayooluwa</p><a href="about.html">read more..</a>
                            </div>
                            <div class="modal-footer">
                    ...
                    <div class="oj-flex-item oj-panel demo-mypanel" style='float: right;' >
                        <div class=" chatbox" >
                            <div class='chatbot-menu-header'>
                                <div class="hng-logo"></div> <span style="align:center;">i.Code</span>
                            </div>
                            <div class="chat-result" id="chat-result">
                                <div class="user-message">
                                    <div class="message">Hello! I'm i.Code Bot! You can ask me anything.   </div>
                                    <div class="message">To Know more about me just type "aboutbot".</div>
...
<!--                    <a href="#" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Lets Chat</a>-->
        ...
        <div class="container" id="socialicons">
            <div class="row">
                ...
                <div class="col-md-2 facebook">
                    <a href="http://www.facebook.com/oyewoas" target="_blank" id="facebook">
                ...
                <div class="col-md-2 socicons">
                    <a href="http://www.twitter.com/oyewoas" target="_blank" id="twitter">
                ...
                <div class="col-md-2 socicons">
                    <a href="http://github.com/oyewoas" target="_blank" id="github">
                ...
                <div class="col-md-2 socicons">
                    <a href="http://www.linkedin.com/oyewoas" target="_blank" id="linkedin">
