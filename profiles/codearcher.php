...
<a href="https://www.linkedin.com/in/codearcher/" target="_blank" class="social_icon">
    <i class="fa fa-linkedin"></i>
                ...
                <div class="App-header2">
                    ...
                    <div class="intro">
                        <p> I like to call myself a full stack developer, but basically i love to build stuff that solves
                            a problem irrespective of the technology involved. I'm more about the impact than the money,
                            but somehow i find both. When i'm not coding, i write, game and eat :)</p></div>
                </div>
            ...
            <div>
                <div class="card">
                    <h3 class="card-header">Work Experiences</h3>
                    <div class="work">
                        <div class="item">
                            ...
                            <div class="job_desc">
                                <p>Learning how to solve problems through coding and become a better team player with the help of awesome mentors and team-mates.</p>
                            </div>
                        </div>
                        <div class="item">
                            <div class="place_desc">
                                <h3 class="place">Zojie Concept</h3>
                                <div class="location">
                                    <i class="fa fa-map-pin"></i> Benin</div>
                            </div>
                            <div class="postion">
                            ...
                            <div class="job_desc">
                                <p>Crafting dynamic websites/web apps with bleeding edge technologies like ReactJS,Angular,NodeJS,PHP.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="item col-sm-12 col-md-12 col-lg-4 ">
                                <div class="item-inner ">
                                    <h3 class="degree">BSc. Computer Science</h3>
                                    <div class="education-body">University Of Benin</div>
                                    <div class="time">2016/17 - 2019/20</div>
                                    <div class="desc">A four year programme that exposed me to Computer Hardware, Algorithm and Data Structures,Basic Web Technologies, Software
                                        Engineering and Artificial intelligence</div>
                                </div>
                            </div>
                            <div class="item col-sm-12 col-md-12 col-lg-4 ">
                                <div class="item-inner ">
                                    <h3 class="degree">Web Developer Certification</h3>
                                    <div class="education-body">Free Code Camp</div>
                                    <div class="time">2015</div>
                                    <div class="desc">An online coding bootcamp program that exposed me to web technologies</div>
                                </div>
                            </div>
                            <div class="item col-sm-12 col-md-12 col-lg-4 ">
                                <div class="item-inner ">
                                    <h3 class="degree">Mobile Web Specialist</h3>
                                    <div class="education-body">Google</div>
                                    <div class="time">....</div>
                                    <div class="desc">Certification exam not yet taken ):</div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="desc">Hypertext Preprocessor is a server-side scripting language which i have use to build backend's of websites </div>
                                </div>
                            </div>
                            <div class="item col-sm-12 col-md-12 col-xl-4">
                                <div class="item-inner ">
                                    ...
                                    <div class="time">Intermediate,3 years</div>
<div class="desc"> A high-level, interpreted programming language which i use for creating dynamic contents on frontend of web apps/websites</div>
                                </div>
                            </div>
                            <div class="item col-sm-12 col-md-12 col-xl-4">
                                <div class="item-inner ">
