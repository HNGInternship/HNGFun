  ...
  <head>
    ...
    /* BOT UI STYLE */
       ...
       <!-- BODY SECTION -->
        ...
        <img src="http://res.cloudinary.com/iambeejayayo/image/upload/v1525095528/bot.png"> <h4> Alpha Bot </h4>
        </div></div>
        ...
        <p>Hello, my name is Alpha.<br /> Bolaji Ayodeji created me. <br /> Feel free to teach me <br /> I love learning new things.</p>
        </div></div>
        ...
        <input class="form-control message chat_input" name="sent-messages" placeholder="Talk to me Buddy!">
