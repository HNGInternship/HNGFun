            ...
            <div class="chat-history">
                ...
                <div class="chat-message clearfix">
                    ...
                    <div class="chat-message-content clearfix">
                        ...
                        <span class="chat-time"><?php echo date('m/d h:i:s'); ?></span>

                        <h5>Amity<!--{{chat.sender}}--></h5>

                        <p><!-- {{chat.message}}-->Hello there, I'm Amity! I'm probably the most intelligent bot out there, i can engage you in random discussions for a long time. </p>
                ...
                <img v-if="chat.sender == 'bot'" src="https://res.cloudinary.com/hnginternship4/image/upload/v1525955602/amity.jpg" alt="" width="32" height="32">
                    ...
                    <div class="chat-message-content clearfix">
                        ...
                        <p>Oh! An interesting fact, i was named after Amity, a real human</p>
