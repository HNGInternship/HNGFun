	...
	<div class="flex-container">
		...
		<div class="content-containter">
			...
			<div class="about"> <!--I may need to fetch my fullname from database-->
				<p>I'm <strong> <?php echo $username ?></strong> From Lagos, NG. I'm a Software Engineer | UI/UX designer | Technology enthusiast | Barcelona FC Fan | I L♥️ve music...Always God first! 😉💯 <br></p>
