<?php 
  try {
      $sql = 'SELECT secret_word, name, username, image_filename FROM secret_word, interns_data WHERE username = \'olagreen\'';
      $q = $conn->query($sql);
                      ...
                      <div class="head">
                        <div class="image" style="width:120px;height:120px;background-image:url(<?php echo $data['image_filename'] ?>);background-size:cover;border-radius:50%;background-repeat:no-repeat;background-position:center center"></div>
                          <div class="name-headline">
                                ...
                                <section>			
                                    <h5>FRONT-END DEVELOPER, BUSINESS ANALYST</h5>
									<h6>Solvay Business School (MBA)</h6>
							<div class="card-text"><b>Username</b>: <?php echo $data['username'] ?><br/>
										<b>LinkedIn url</b>: <a href="https://www.linkedin.com/in/aolanito" target="_blank"><?php echo $data['username'] ?></a>
										<b>Git url</b>: <a href="https://github.com/olagreen" target="_blank"><?php echo $data['username'] ?></a>
                            </div>
                                </section>
                          </div>
                        </div>
