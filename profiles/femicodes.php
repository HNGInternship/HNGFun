...
<html>
	<head>
		<title>Aghedo Joseph Femi</title>
		<meta charset="utf-8" />
		...
		<meta name="author" content="Aghedo Joseph Femi">
...
?>
						...
						<nav>
							<ul>
								<li><a href="https://twitter.com/femicodes" class="icon fa-twitter"><span class="label">Twitter</span></a></li>
								<li><a href="https://linkedin.com/in/aghedo-joseph" class="icon fa-linkedin"><span class="label">Linkedin</span></a></li>
								<li><a href="https://stackoverflow.com/users/7046279/joseph-sarz" class="icon fa-stack-overflow"><span class="label">StackOverflow</span></a></li>
								<li><a href="https://github.com/josephsarz" class="icon fa-github"><span class="label">Github</span></a></li>
								<li><a href="mailto:aghedojoe007@gmail.com" class="icon fa-envelope-o"><span class="label">Email</span></a></li>
							</ul>
						</nav>
					</header>
