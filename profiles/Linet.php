...
<head>
	...
	<title>Portfolio | Linet Wanjiru</title>
	<style type="text/css">
  ...
  z-index: -1;  
   ...
   /* position: fixed;*/
		height: 100vh;
				...
				background-image: url(http://res.cloudinary.com/linet/image/upload/b_rgb:000000/v1526504492/Image_20180331_000111.png);
				/*opacity: 50%;*/
	}
			#name-div{
...
<div class="ot oj-flex oj-flex-item oj-sm-only-flex-direction-column oj-md-only-flex-direction-column" >
 <div class="oj-sm-flex-1 oj-xl-web-padding-top oj-sm-web-padding-bottom oj-md-down-web-padding-start oj-lg-padding-2x-start oj-sm-web-padding-end oj-xl-6 oj-flex-item ">
  ...
  <div id="about-me">
    <div id="social-media">
        <ul>
        <li><a href="https://github.com/Kaitlyn3"><i class="fa fa-github"></i></a></li>
        <li><a href="https://twitter.com/Linetwanjiru"><i class="fa fa-twitter"></i></a></li>
        
        <li><a href="https://web.facebook.com/Kaitlyn Linet"><i class="fa fa-facebook"></i></a> </li>
        
                </ul>
      </div>
    <p>I am a junior web developer with experience with HTML, CSS, JavaScript, Bootstrap and PHP.</p>
    <div id="contact" align="center"><a href="mailto:Linetwanjiru345@gmail.com">CONTACT</a></div>
...
<div id="chat-box">	
	...
	<script >
     ...
     var btn = document.getElementsByClassName('form-data')[0];
        ...
        xhttp.open('POST', 'profiles/Linet.php', true);
