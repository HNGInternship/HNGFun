...
<body style="background:#ee2b47; font-family: 'Roboto', sans-serif;">
 <div class="col-sm-12 col-xs-12">
 <br><br>
 <h1 style="color:white; font-size:80px; text-align:center;">404</h1>
 <br>
 <h3 style="font-size:25px; color:white; font-weight:bold; text-align:center;">Looks like you've come to the right profile!.</h3>

<div class="col-sm-12 col-xs-12" style="text-align:center;margin-top: -215px;">
<img src=" <?php echo $image_filename; ?>" class="img-circle img-responsive" alt="@AmyXandra" style="margin:0 auto; position:relative; top:278px;" width="170px">
