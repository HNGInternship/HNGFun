...
require './db.php';
  ...
  try {
    ...
    $sql_query = 'SELECT * FROM interns_data WHERE username="teegoldz"';
...
<main id="profileContainer" class="container">
          ...
          <div class="profile-card">
            <img src="<?php echo $image_url ?>" alt="Teegoldz" class="profile-image" />
        ...
        <a href="https://www.github.com/teegold007" class="fa-icon" target="_blank">
          <i class="fa fa-fw fa-github-alt"></i>
        </a>
        <a href="https://www.twitter.com/teegoldz" class="fa-icon" target="_blank">
          <i class="fa fa-fw fa-twitter"></i>
        </a>
       
        <a href="www.linkedin.com/in/tosin-okunniga" class="fa-icon" target="_blank">
          <i class="fa fa-fw fa-linkedin"></i>
        </a>
        <a href="mailto:okunnigatosin@gmail.com" class="fa-icon" target="_blank">
