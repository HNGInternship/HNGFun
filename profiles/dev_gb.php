...
function help() {
   $help = "<div id='result'>These is a sample format of a question  </br></br>What is the capital of Lagos?  </br></br>For compound names separate with a dash  </br></br>e.g What is the capital of Ekiti?</br></div>"
    echo $help;
}
