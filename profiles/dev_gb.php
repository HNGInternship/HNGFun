...
\*------------------------------------*/
            ...
            setTimeout(function(){
                     $(' <div class="messages clear"><span class="avatar"></span><div class="sender"><div class="message-container"><div class="message"><p>'+result+'</p></div><span class="delivered"><?php
            echo "" . date("h:i:a");
