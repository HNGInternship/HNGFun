	...
	<div class="iii">
	        ...
	        if($password == 'password') {
	            ...
	            if(empty($data)) {
	              ...
	              VALUES (
	                ...
	                echo json_encode([
	                	'status'=>1,
	                	'answer'=>"I already know this command, try teaching me somethong else"
	                ]);
	                return;
	            }
	        }else {
	    ...
	    function getAnswer($input) {
	        ...
	        if(empty($data)){
	            echo json_encode([
	            	'status'=>0,
	            	'answer'=>"Sorry, I do not understand that command. You can train me using this format train:Question # Answer # Password"
	            ]);
	            return;
	        }else {
