		...
		<div class="col-sm-7">
			...
			<form class="form-inline row d-flex justify-content-center">
				...
				<div class="col-4 form-group">
					<button class="btn btn-custom-primary text-white py-2" style="border-top-left-radius: 0; border-bottom-left-radius: 0; font-size: 1.1rem; min-width: 90%;">Apply Now</button>
				</div>
			</form>
		</div>
